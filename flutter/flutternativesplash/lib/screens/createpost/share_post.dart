...
class SharePost extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: SharepostPage(image: image,),
    );
  }
}
  ...
  void registerEventPost () async { 
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print("Failed to post event: ${response.statusCode} ${response.body}");
      }
    } catch (e) {
              ...
              builder: (buttonController) { 
                return Row( 
                  ...
                  children: [  
                    ...
                    GestureDetector(
                          ...
                          child: Icon(
                            Icons.library_books,
                            color: buttonController.postType == 'event_post'
                        ...
                        GestureDetector(
                          ...
                          child: Icon(
                            ...
                            color: buttonController.postType == 'profile_post'
                                ? const Color.fromARGB(255, 70, 69, 60)
                                : Colors.white, 
                                size: 40,
                          ),
                        ...
                        GestureDetector(
                          ...
                          child: Icon(
                            ...
                            color: buttonController.postType == 'study_post'
                                ? const Color.fromARGB(255, 70, 69, 60)
                                : Colors.white, 
                                size:40,
                          ),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    foregroundColor: const Color.fromARGB(255, 245, 207, 40),  
                    backgroundColor: Colors.black, 
