...
import 'package:flutternativesplash/screens/events/NetworkHandler.dart';
import 'package:flutternativesplash/screens/events/events1.dart'; 
import 'package:flutternativesplash/screens/games/gamehome.dart'; 
import 'package:flutternativesplash/screens/studies.dart';
...
class _EventsPageState extends State<_EventsPage> {  
  ...
  Future<void> eventinformation( BuildContext context, Map<String, dynamic> event) async {  

  try {     
    if (mounted) { 
      Navigator.push( 
        context, 
        MaterialPageRoute(builder:(context) => EventInformation(event: event),)
      );
    }
} catch (e) { 
  // ignore: avoid_print
...
Widget eventWidget(BuildContext context, String titlepost, String caption, String imageUrl, Map<String, dynamic> event ) {  
