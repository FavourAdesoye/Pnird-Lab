      ...
      if (pickedFile != null) {
        ...
        if (mounted) {
          Navigator.push(
            ...
            context,
            MaterialPageRoute(
                builder: (context) => ViewImagePage(image: image)),
          );
        }
      }
    } catch (e) {
            ...
            child: Column(
              ...
              children: [
                const Padding(
                  ...
                  child: Text(
                      "Allow PNIRD to access your camera and microphone ",
                      maxLines: 2,
                      style: TextStyle(
                          color: Colors.white,
                ...
                const Padding(
                  padding: EdgeInsets.only(bottom: 15),
                  child: Text("How you'll use this",
                      style: TextStyle(
                          color: Colors.white,
                          fontWeight: FontWeight.bold,
                          fontSize: 20)),
                ...
                const Padding(
                  padding: EdgeInsets.only(bottom: 15),
                  child: Text(
                      "To select photos and videos,and preview visual/audio effects",
                      style: TextStyle(
