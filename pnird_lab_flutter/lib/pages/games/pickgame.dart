...
@override
    Widget build(BuildContext build){ 
      return Scaffold( 
        ...
        appBar: AppBar(  
        title: const Text("Choose a game", style: TextStyle( color: Colors.white) ),
        centerTitle: true,
        ...
        leading: IconButton( 
          ...
          color: Colors.white,
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const Gamehome()) );
            } 
            
          ),   

          actions: [ 
            IconButton(onPressed: () {Navigator.pop(context);} , icon: const Icon(Icons.arrow_forward_outlined), 
            color: Colors.white,)
          ], 
        ), 
  ...
  Widget build(BuildContext context) {
    return Center( 
      ...
      children:  <Widget> [Card(  
        ...
        child: InkWell(
          ...
          child: const SizedBox( 
            ...
            height: 100,
            child: Center( 
            child: Text('Color Switch', style: TextStyle(color: Colors.white, fontSize: 20),),
          )),
        ),
      ), 
      ...
      Card(  
        ...
        child: InkWell(
          onTap: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => const ChessHome()) );
          },
          child: const SizedBox( 
            ...
            child: Center(
            child: Text('Chess', style: TextStyle(color: Colors.white, fontSize: 20),),
          )),
        ),
      ), 
       ...
       Card(  
        ...
        child: InkWell(
          ...
          child: const SizedBox( 
            ...
            child: Center(
            child: Text('Flappy Brain', style: TextStyle(color: Colors.white, fontSize: 20),), 
            )
          ),
        ),
      ), 
